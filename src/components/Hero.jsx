            ...
            lg:mt-14 mt-14'>
                ...
                lg:items-start text-center lg:text-left mb-12 lg:mb-0'>
                    ...
                    <p className={`mb-6 sm:mb-8 leading-relaxed max-w-md
                        ...
                        data-aos='fade-up'
                        data-aos-delay='600'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim quod sed aliquam magni dolores. Aspernatur mollitia quidem eius eveniet corporis, iure vitae perspiciatis culpa aliquam voluptatum, necessitatibus, asperiores laboriosam sit?
                    </p>
                    {/* Buttons */}
                    <div className='w-full pt-4 sm:pt-6'>
                        ...
                        data-aos-delay='700'>
                            <a href={CV} download className='w-full sm:w-auto'>
                                ...
                                py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0,0.7)]
                                rounded-full text-base sm:text-lg font-semibold transition-alll
                ...
                >
                    <div className='relative w-4/5 sm:w-3/4 lg:w-full'>
                        ...
                        className='absolute -top-7 sm:top-4 left-32
                        sm:left-20 w-20 h-20 sm:w-20 sm:h-20 object-contain
                        animate-bounce opacity-90 z-30'/>
                    </div>
                </div>
            </div>
